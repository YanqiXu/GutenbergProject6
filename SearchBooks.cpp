...
int main() {
  ...
  form_iterator showMatchesIt = cgi.getElement("showmatches");
  string term = **termIt;
  string stime = **timeIt;
  string showMatchesStr = **showMatchesIt;
  showMatches=false;
  if (showMatchesStr == "on") {
    showMatches = true;
  }
  ...
  cout << "<br />The word " << term << " found " << matchCount <<
    " times in " << fileMatchCount << " books and " << wordCount <<
    " words" << endl;
  cout << "<br />Total Books: " << fileCount << endl;
